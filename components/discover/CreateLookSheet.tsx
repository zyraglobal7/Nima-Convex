...
import { X, Sparkles, Loader2, Check, AlertCircle, Share2, Globe, Users, Link as LinkIcon, ExternalLink } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <div className="px-6 py-4 overflow-y-auto max-h-[60vh]">
            {/* Completed state - show generated image and share options */}
            {status === 'completed' && generatedImageUrl ? (
              ...
              >
                ...
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-border">
                  ...
                  />
                  {/* Success overlay */}
                  <div className="absolute top-3 right-3 px-3 py-1.5 bg-green-500/90 backdrop-blur-sm rounded-full flex items-center gap-1.5">
